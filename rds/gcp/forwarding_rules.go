...
import (
	...
	configpb "github.com/rishabhgargsde/cloudprober/rds/gcp/proto"
	pb "github.com/rishabhgargsde/cloudprober/rds/proto"
	"github.com/rishabhgargsde/cloudprober/rds/server/filter"
...
// frData struct encapsulates information for a forwarding rule.
type frData struct {
	ip     string
	region string
}
