...
#Schedule: {
	#Weekday: {"DEFAULT_EVERYDAY", #enumValue: 0} |
		{"SUNDAY", #enumValue: 1} |
		{"MONDAY", #enumValue: 2} |
		{"TUESDAY", #enumValue: 3} |
	...
	startWeekday?: #Weekday @protobuf(2,Weekday,name=start_weekday,"default=DEFAULT_EVERYDAY")
	...
	endWeekday?: #Weekday @protobuf(4,Weekday,name=end_weekday,"default=DEFAULT_EVERYDAY")
